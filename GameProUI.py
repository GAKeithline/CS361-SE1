...
class GameLib:
    ...
    def add_game(self):
        ...
        x = input("Enter 'y' to delete, enter any other key to abort: ")
        if x == 'y':
...
while close_command != 'close':
    print("---------"), print("Home Page"), print("---------")
    print("What would you like to do? \n")
    print("Type 'add game' to add a new game to the library.")
    print("Type 'library' to view, edit, and delete existing games.")
    x = input("Enter any command other than 'add game' or 'library' to exit: ")
    if x == "add game":
        print("---------"), print("Add Game"), print("---------")
